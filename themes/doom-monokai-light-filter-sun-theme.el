;;; doom-monokai-light-filter-sun-theme.el --- A light-filter-sun port of Monokai Pro Light-Filter-Sun theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Author: AI Assistant
...
;;; Commentary:
;;
;; A faithful port of the Monokai Pro Light-Filter-Sun theme from VSCode to Emacs.
...
;;; Variables
(defgroup doom-monokai-light-filter-sun-theme nil
  "Options for the `doom-monokai-light-filter-sun' theme."
  :group 'doom-themes)

(defcustom doom-monokai-light-filter-sun-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-monokai-light-filter-sun-theme
  :type 'boolean)

(defcustom doom-monokai-light-filter-sun-brighter-comments nil
  "If non-nil, comments will be highlight-filter-suned in more vivid colors."
  :group 'doom-monokai-light-filter-sun-theme
  :type 'boolean)

(defcustom doom-monokai-light-filter-sun-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to determine the exact padding."
  :group 'doom-monokai-light-filter-sun-theme
  :type '(choice integer boolean))

;;; Theme definition
(def-doom-theme doom-monokai-light-filter-sun
  "A light-filter-sun port of Monokai Pro Light-Filter-Sun theme"

  ;; Main theme colors (exact VSCode color codes)
  (
    ;; Base colors from VSCode Monokai Pro Light-Filter-Sun
    ;; (bg-main        '("#faf4f2" "#faf4f2" "white"       ))  ; editor.background
    (bg-main        '("#F8EFE7" "#F8EFE7" "white"       ))  ; editor.background
    (bg-alt         '("#F8EFE7" "#F8EFE7" "brightwhite" ))  ; Various widget backgrounds
    (bg-sidebar     '("#ede7e5" "#ede7e5" "brightblack" ))  ; sideBar.background
    (bg-highlight-filter-sun   '("#EEE6DE" "#EEE6DE" "grey"        ))  ; editor.lineHighlight-filter-sunBackground
    ...
    ;; Syntax highlight-filter-suning colors (exact VSCode mappings)
    ...
    (comments       (if doom-monokai-light-filter-sun-brighter-comments fg-alt fg-comment))
    (doc-comments   (if doom-monokai-light-filter-sun-brighter-comments fg-alt fg-comment))
    ...
    ;; Modeline colors
    (modeline-bg                (if doom-monokai-light-filter-sun-brighter-modeline base3 bg-sidebar))
    (modeline-fg                fg-main)
    (modeline-bg-alt            (if doom-monokai-light-filter-sun-brighter-modeline base4 base3))
    ...
    (modeline-pad
      (when doom-monokai-light-filter-sun-padded-modeline
        (if (integerp doom-monokai-light-filter-sun-padded-modeline)
            doom-monokai-light-filter-sun-padded-modeline
          4))))
  ...
  (
    ...
    ((font-lock-comment-face &override)
      :slant 'italic
      :background (if doom-monokai-light-filter-sun-brighter-comments (doom-blend teal bg-main 0.07)))
    ...
    (mode-line-emphasis
      :foreground (if doom-monokai-light-filter-sun-brighter-modeline fg-main fg-alt))
    ...
    (ivy-minibuffer-match-highlight-filter-sun :foreground red :weight 'bold)
...
;;; doom-monokai-light-filter-sun-theme.el ends here

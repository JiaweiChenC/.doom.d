...
;; Fix SVG rendering: org--create-inline-image passes :scale 1 alongside
;; :max-width which conflicts for SVGs using viewBox without explicit dimensions.
;; Use the svg type with :width only.
(after! ol
  (defun jw/org--create-inline-image-svg-fix (orig-fn file width)
  ...
  (advice-add 'org--create-inline-image :around #'jw/org--create-inline-image-svg-fix))

...
(custom-set-variables
 ...
 '(safe-local-variable-values
   '((eval setq quickrun-option-default-directory
...
(custom-set-faces
 ...
 '(mode-line ((t :background "White" :overline "black" :box (:line-width 1 :color "White" :style nil))))
 '(mode-line-active ((t :background "White" :overline "black" :box (:line-width 1 :color "White" :style nil))))
 '(mode-line-highlight ((t :box (:color "Black"))))
 '(mode-line-inactive ((t :background "White" :overline "grey50" :box (:line-width 1 :color "White" :style nil))))

(custom-set-variables
 ...
 '(package-selected-packages
   '(treemacs-all-the-icons olivetti leuven-theme zotxt org-fragtog evil-matchit auctex latex-math-preview imenu-list cdlatex lsp-python-ms org-roam-ui visual-fill-column ts request pdf-tools org-roam org-bullets ht flycheck-pycheckers dracula-theme deferred))
 '(rustic-ansi-faces

...
(def-doom-theme doom-biscuit-light
  ...
  ((bg         '("#FFF7EB" nil       nil))
   ...
   (grey base4)
   (red       '("#AE4750" "#C8767D" "red"))
   (orange    '("#C6695D" "#DB9A91" "brightred"))
   (green     '("#97916F" "#AFA49B" "green"))
   (teal      '("#7A7F7F" "#A5A7A3" "brightgreen"))
   (yellow    '("#CD9165" "#D4A391" "yellow"))
   (blue      '("#7B727E" "#A69DA4" "brightblue"))
   (dark-blue '("#79657A" "#9D8A9E" "blue"))
   (magenta   '("#83546B" "#A3728B" "magenta"))
   (violet    '("#A05A78" "#89728a" "brightmagenta"))
   (cyan      '("#7A7F7F" "#A5A7A3" "brightcyan"))
   (dark-cyan '("#7B727E" "#A69DA4" "cyan"))
